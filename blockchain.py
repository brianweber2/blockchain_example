...
from urllibr.parse import urlparse
import requests
...
class Blockchain(object):
  ...
  def hash(block):
    ...
    # We must make that the Dictionary is Ordered, or we'll have inconsistent
    # hashes
  ...
  def resolve_conflicts(self):
    ...
    chain with the longest on in the network.

    :return: <bool> True if our chain was placed, False if not
    """
